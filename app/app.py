...
def main():
    ...
    # Crear formulario solo con características seleccionadas
    ...
    if submitted:
        ...
        try:
            # Crear datos de entrada - Solo características seleccionadas
            input_data = {
            ...
            # Aplicar encoding - crear variables dummy (MISMO PARÁMETRO QUE EN ENTRENAMIENTO)
            ...
            # Llenar con los valores codificados - USAR get_dummies de forma consistente
            for col in X_encoded.columns:
                if col in model_features:
                    X_final[col] = X_encoded[col].values[0]
            
            # Asegurar que todas las características estén presentes y con valores correctos
